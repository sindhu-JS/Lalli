...
export class ApiService {
  ...
  get<T>(
    ...
    return (
      this.http.get<ApiResponse<T>>(url, httpOptions) as unknown as Observable<
        ApiResponse<T>
      >
    ).pipe(
  ...
  uploadFile<T>(
    ...
    return (
      this.http.post<ApiResponse<T>>(url, formData) as unknown as Observable<
        ApiResponse<T>
      >
    ).pipe(
  ...
  private cleanParams(params: { [key: string]: any }): {
    [key: string]: string;
  } {
