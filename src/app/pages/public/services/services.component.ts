    ...
    <div class="services-page">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div
              class="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center mb-4"
            >
...
export class ServicesComponent {
  services = [
    ...
    },
    {
      ...
      icon: 'pi pi-link',
      description:
        'RESTful APIs and microservices architecture for seamless integrations.',
      features: [
        'RESTful Design',
        'Authentication',
        'Rate Limiting',
    ...
    },
    {
      ...
      icon: 'pi pi-database',
      description:
        'Optimized database architecture and data modeling for your applications.',
      features: [
        'Performance Tuning',
        'Data Migration',
        'Backup Strategies',
