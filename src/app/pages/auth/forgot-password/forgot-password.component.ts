  ...
  template: `
    <div class="forgot-password-form">
      ...
      >
        <div>
          ...
          <p-message
            severity="error"
            class="mt-1"
            [text]="forgotPasswordForm.get('email')?.errors?.['required'] ? 'Email is required' : 'Please enter a valid email address'"
          ></p-message>
          }
        </div>
      ...
      <div class="text-center">
        ...
        >
          <i
            class="pi pi-envelope text-green-600 dark:!text-green-400 text-2xl"
          ></i>
        </div>
