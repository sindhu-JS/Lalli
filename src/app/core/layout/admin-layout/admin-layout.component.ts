        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
              ...
              <h1 class="text-xl font-semibold text-gray-900 dark:!text-gray-100">Admin Dashboard</h1>
            </div>
            <div class="flex items-center space-x-4">
              ...
              <button
                ...
                <span class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ currentUser()?.name || 'Admin' }}</span>
              </button>
              <button
                (click)="logout()"
      ...
      <div class="flex">
        ...
        <aside class="w-64 bg-white dark:!bg-gray-800 shadow-sm min-h-screen">
          <nav class="mt-8 px-4">
            <ul class="space-y-2">
              <li>
                <a routerLink="/admin/dashboard" routerLinkActive="bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
              ...
              <li>
                <a routerLink="/admin/users" routerLinkActive="bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200">
              ...
              <li>
                <a routerLink="/admin/settings" routerLinkActive="bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200">
