    ...
    <div class="team-page">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex space-x-3">
            <p-button
              ...
              [outlined]="true"
            ></p-button>
            <p-button label="Invite Member" icon="pi pi-plus"></p-button>
          </div>
        </div>
      </div>
      ...
      <div class="text-center py-12">
        ...
        <p class="text-gray-600 dark:!text-gray-400 mb-6">
          ...
          results. } @else { Get started by inviting your first team member. }
        </p>
        @if (!hasActiveFilters()) {
        <p-button label="Invite First Member" icon="pi pi-plus"></p-button>
        }
      </div>
      }
    </div>
