...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, FormsModule, ButtonModule, CardModule, SelectModule],
  template: `
...
export class NotificationsComponent implements OnInit {
    ...
    this.notifications = [
      {
        ...
        message: 'The "Web Redesign" project has been updated with new requirements.',
        type: 'info',
        read: false,
      ...
      },
      {
        id: 5,
        title: 'Task Deadline',
        message: 'The task "API Integration" is due tomorrow. Please update the status.',
        type: 'warning',
        read: false,
      ...
      },
      {
        id: 7,
        title: 'Server Error',
        message: 'Application server experienced temporary downtime. All services are now restored.',
        type: 'error',
        read: true,
  ...
  filterNotifications(): void {
    this.filteredNotifications = this.notifications.filter(notification => {
      ...
      const matchesSource = !this.selectedSource || notification.source === this.selectedSource;
  ...
  getNotificationClasses(notification: Notification): string {
    const baseClasses = '';
    return notification.read ? baseClasses : baseClasses + ' border-l-4 border-l-blue-500';
  }
